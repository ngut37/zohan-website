// regex for trimmed phone numbers
export const phones = {
  // checked
  'cs-CZ': /^((\+|00)?420)?[1-9]\d{8}$/,
  'sk-SK': /^((\+|00)421)[1-9]\d{8}$/,
  'de-DE': /^((\+|00)49)\d{8,11}$/,
  'de-AT': /^((\+|00)43)\d{9,11}$/,
  'en-GB': /^((\+|00)44)[1-9]\d{6,9}$/,
  'pl-PL': /^((\+|00)48)[1-9]\d{8}$/,
  'ch-CH': /^((\+|00)41)[1-9]\d{8}$/,
  'hr-HR': /^((\+|00)385)[1-9]\d{7,8}$/,
  'fr-FR': /^((\+|00)33)\d{9}$/,
  'en-US': /^((\+|00)1)\d{10,11}$/,
...
export type PhoneTypes = keyof typeof phones;
